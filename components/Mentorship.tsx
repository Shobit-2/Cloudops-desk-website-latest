        ...
        <section id="mentorship" className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {/* Interview Prep */}
                    <GlassCard className="p-10 flex flex-col group relative overflow-hidden" hoverEffect>
                    ...
                    {/* Job Support */}
                    <GlassCard className="p-10 flex flex-col group relative overflow-hidden border-primary-500/30 bg-primary-500/[0.02]" hoverEffect>
                        <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
